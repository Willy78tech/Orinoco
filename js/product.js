...
const listCams = document.getElementById('fromServer');
/*
* Appel de la fonction getCameras() en passant l'url de l'API en paramètre
* - then: si réussi, parse la réponse, affiche la réponse dans la console et appel la fonction createListCams() en prenant en paramètre la réponse parsée
